...
export const metadata: Metadata = {
  ...
  description:
    "Peça sua conta e cartão de crédito do Nubank - Empréstimo. Transparentes, seguros e do seu jeito. Opções de empréstimos que deixam você no controle sempre",
  ...
  verification: {
    google:
      "google-site-verification=FYoOGkzHFgI2WUdeqlv11lIxxBk0yf4NpQwExOgba_4",
  },
};
...
export default function RootLayout({
  ...
  return (
    <html lang="pt-br" className="scroll-smooth user-selection overflow-x-clip">
      <body
        className={`${sora.variable} ${sourceSansPro.className} bg-white-dark`}
      >
        <Navbar />
