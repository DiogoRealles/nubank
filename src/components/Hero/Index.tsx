    ...
    <section id="hero" className="section">
      ...
      <div className="container-center">
        <div className="hero-wrapper">
          <div data-aos="fade-right" data-aos-delay="100" data-aos-duration="700" className="flex-item-1">
            <h1 className="h1">{
              HERO_TEXT[0]
            }</h1>
            <p className="body-16">{
          ...
          <div data-aos="zoom-in" data-aos-delay="300" data-aos-duration="1000" className="flex-item-3 div-card">
